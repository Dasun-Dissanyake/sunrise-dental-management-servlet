...
public class TreatmentDAO {
    ...
    public boolean save(Treatment treatment) throws SQLException {
        String sql = """
                ...
                (treatment_code, treatment_name, description, treatment_cost, consultation_fee, created_at, active)
                VALUES (?, ?, ?, ?, ?, ?, ?)
                """;
    ...
    public Treatment findByTreatmentCode(String treatmentCode) throws SQLException {
        String sql = """
                SELECT *
                FROM treatments
    ...
    private Treatment mapResultSetToTreatment(ResultSet resultSet) throws SQLException {
        ...
        double cost = resultSet.getDouble("treatment_cost");
